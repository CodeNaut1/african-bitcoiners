export function bountyIdeaEmail({
  name,
  feedbackTitle,
}: {
  name: string
  ...
  return {
    subject: 'We Love Your Idea — Update on Your Feedback',
    html: `<!DOCTYPE html>
<html lang="en">
<head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Feedback Idea</title></head>
      ...
      <table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:12px;overflow:hidden;border:1px solid #E5E7EB;max-width:600px;width:100%;">
        ...
        <tr><td style="padding:40px;">
          ...
          <p style="color:#333;font-size:15px;line-height:1.7;margin:0 0 20px;">
            Great news — we love your idea! 💡
          </p>
          <div style="background:#FFF9F5;border:1px solid #E5E7EB;border-radius:8px;padding:20px;margin:0 0 24px;">
            <p style="margin:0 0 8px;font-size:13px;color:#667085;font-weight:bold;text-transform:uppercase;letter-spacing:1px;">Your Idea</p>
            <p style="margin:0;font-size:15px;color:#253343;font-weight:600;">${feedbackTitle}</p>
          </div>
          <p style="color:#333;font-size:15px;line-height:1.7;margin:0 0 20px;">
            Your suggestion has been categorized as an <strong>Idea</strong> and is now under consideration by our team. We are exploring the best way to bring it to life.
          </p>
          <p style="color:#333;font-size:15px;line-height:1.7;margin:0 0 20px;">
            If we move forward and implement your idea, you will be notified and rewarded accordingly through our feedback bounty program.
          </p>
          <p style="color:#333;font-size:15px;line-height:1.7;margin:0 0 24px;">
            Thank you for helping shape the future of African Bitcoiners!
          </p>
