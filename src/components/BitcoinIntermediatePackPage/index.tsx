...
import { CARDS, LINKS, type ResourceCard } from '@/components/BitcoinIntermediatePackPage/data'
...
export function BitcoinIntermediatePackPage() {
  return (
      ...
      <section className="px-4 pt-[50px] sm:px-6">
        <div className="mx-auto max-w-[800px] text-center">
          ...
          <p className="mt-4 text-base" style={{ color: HEADING }}>
            Based on the questions you answered you are a Bitcoin Intermediate. These are some contents you will like
          </p>
        </div>
      </section>
