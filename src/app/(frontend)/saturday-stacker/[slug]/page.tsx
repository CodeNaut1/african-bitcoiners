  ...
  return (
    <div>
      ...
      <div className="bg-white">
        {post.excerpt && (
          <Container narrow className="py-10 pb-0">
            <p className="text-lg text-brand-text-mid leading-relaxed font-medium border-l-4 border-brand-primary pl-4">
              {post.excerpt}
            </p>
          </Container>
        )}
        ...
        {(post as any).rawHtml ? (
          <div
            className="newsletter-content mx-auto"
