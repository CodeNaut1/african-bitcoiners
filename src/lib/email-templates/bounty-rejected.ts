export function bountyRejectedEmail({
  ...
  return {
    subject: 'Update on Your African Bitcoiners Feedback Submission',
    html: `<!DOCTYPE html>
<html lang="en">
<head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Feedback Update</title></head>
      ...
      <table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:12px;overflow:hidden;border:1px solid #E5E7EB;max-width:600px;width:100%;">
        ...
        <tr><td style="padding:40px;">
          ...
          <p style="color:#333;font-size:15px;line-height:1.7;margin:0 0 20px;">
            Thank you for submitting your feedback to African Bitcoiners. We appreciate every suggestion and idea our community shares with us.
          </p>
          ...
          <p style="color:#333;font-size:15px;line-height:1.7;margin:0 0 20px;">
            After careful review, we were not able to accept this particular submission for the bounty program at this time. This may be because a similar suggestion has already been submitted, or it falls outside the current scope of our bounty criteria.
          </p>
