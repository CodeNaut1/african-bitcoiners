...
import { OTHER_YEARS } from '@/components/HallOfFamePage/data'
...
export function HallOfFameTicker() {
  ...
  return (
    <div className="mx-auto flex max-w-[1200px] items-stretch overflow-hidden rounded-sm bg-white shadow-sm">
      <div className="flex shrink-0 items-center px-5 py-4 md:px-8" style={{ backgroundColor: TICKER_ORANGE }}>
        <span className="whitespace-nowrap text-xs font-bold uppercase tracking-wide md:text-sm" style={{ color: TICKER_CREAM }}>
          View All Years
        </span>
      </div>
      ...
      <div className="flex min-w-0 flex-1 items-center justify-between gap-2 px-4 py-3 md:px-6">
        <button
          ...
          className="shrink-0 text-[22px] leading-none text-[#FFFCF0] transition-colors hover:text-[#CB5F00] md:text-[#222]"
        >
          ‹
        </button>
