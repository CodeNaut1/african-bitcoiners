...
export const IMG = {
  unhappy: `${R2}/uploads/2022/09/unhappy.png`,
...
export const SHARE_LINKS = {
  ...
  twitter: `https://twitter.com/share?url=${encodeURIComponent(COURSE_URL)}&text=${encodeURIComponent(
    'looking for a fantastic way to learn about Bitcoin? Check out @afribitcoiners Bitcoin for Beginners course delivered via email. Click here to subscribe to the course',
